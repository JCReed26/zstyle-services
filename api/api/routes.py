...
# Note: UserMemory is temporarily disabled - OpenMemory is external HTTP service
...
async def get_user_state(
    ...
    try:
        ...
        # Memory counts - OpenMemory is external HTTP service
        # Memory data is stored in OpenMemory, not in database
        memory_count = 0
