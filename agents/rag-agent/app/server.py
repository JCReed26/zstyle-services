...
bucket_name = f"gs://{project_id}-rag-agent-logs-data"
...
agent_name = os.environ.get("AGENT_ENGINE_SESSION_NAME", "rag-agent")
...
app.title = "rag-agent"
app.description = "API for interacting with the Agent rag-agent"
